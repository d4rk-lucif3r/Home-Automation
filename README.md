...
- This application makes use of:
  ...
  - A Database **HomeAutomation.db** is created upon Install. This Database contains two Tables Room and Address. 
    ...
    - Address Table Stores paired device **address** and its **name**. Address table is used to make a prompt for connecting to last device connected with app Automatically with out going to actually pair with that device from App settings. 
